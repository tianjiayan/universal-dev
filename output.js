{
  ...
  module: {
    ...
    rules: [
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            ...
            options: {
              cacheDirectory: 'F:\\实训\\universal-dev\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: '021f574f'
            }
          },
      ...
      /* config.module.rule('svg') */
      {
        test: /\.(svg)(\?.*)?$/,
        exclude: [
          'F:\\实训\\universal-dev\\src\\assets\\icons'
        ],
        use: [
  ...
  plugins: [
    ...
    new DefinePlugin(
      {
        'process.env': {
          ...
          VUE_APP_SERVICE_URL: '"https://imooc-admin.lgdsunday.club/prod-api"',
          BASE_URL: '"/"'
        }
      }
    ),
    ...
    new HtmlWebpackPlugin(
      {
        title: 'universal-templent',
        templateParameters: function () { /* omitted long function */ },
        template: 'F:\\实训\\universal-dev\\public\\index.html'
      }
    ),
    ...
    new CopyPlugin(
      [
        {
          from: 'F:\\实训\\universal-dev\\public',
          to: 'F:\\实训\\universal-dev\\dist',
          toType: 'dir',
          ignore: [
            '.DS_Store',
            {
